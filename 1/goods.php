...
/****
具体商品页面
goods.php?goods_id=N

作用:
展示商品具体信息

思路:
取出商品详细信息,及商品对应的品牌信息,(左连接)
...
$info = $goodsModel->goodsInfo($goods_id);
...
// 取出商品的栏目id,再计算该栏目的家谱树
$cateModel = new cateModel();
$nav = $cateModel->familyTree($cateModel->cateList(),$info['cat_id']);
//$info['cat_id']
...
<div id="nav">
	...
	<DIV class="navr_recent" >
		...
		<a href="#" title="查看购物车"><a href="flow.php?act=cart" title="查看购物车">查看你的购物车</a></a></A>
...
<div class="position">
    ...
    <span>
        ...
        <a href="category.php?cat_id=<?php echo $n['cat_id']; ?>">
            <?php echo $n['cat_name']; ?>
        </a>
        <code>
            &gt;
    ...
    <div class="detail_l">
        <div class="detail_pic">
         <a href="javascript:;" onclick="window.open('gallery.php?id=9'); return false;">
                <img src="<?php echo $info['goods_img']; ?>" alt="<?php echo $info['goods_name']; ?>"
                name="goods_img_id" id="goods_img_id" />
            </a>
        </div>
        <div class="detail_smallpic">
 <div class="detail_smallpic_header">
			<a href="javascript:" onmousedown="clickRight()" onmouseout="scrollStop()">

				<img src="view/images/detail_header.gif" border="0">
			</a>
		</div>
		<div id="demo" class="detail_smallpic_body">
			<div style="height: 240px; margin-top: 5px;" id="demo1" class="gallery">
				<ul>
					<li>
						<a href="gallery.php?id=9&amp;img=14" target="_blank">
							<img onmouseover="img_src('<?php echo $info['goods_img']; ?>')" alt="<?php echo $info['goods_name']; ?>" src="<?php echo $info['goods_img']; ?>" alt="<?php echo $info['goods_name']; ?>" width="81" />
			...
			<div id="demo2" style="overflow: visible; display: inline; height: 240px;">	
			</div>
		</div>
            <div class="detail_smallpic_footer">
                <a href="javascript:;" onmousedown="clickLeft()"
                onmouseout="scrollStop()">
                    <img src="view/images/detail_footer.gif" border="0">
                </a>
            </div>
        </div>
        <div class="clear">
    ...
    <div class="detail_r">
        ...
        <div style="width: 100%; padding-top: 10px;">
                ...
                <ul style="border-bottom: medium none;">
                    <li style="width: 260px; float: left; margin-right: 10px; margin-top: 5px;">
                        ...
                        <span style="text-decoration: line-through;">
                            ￥<?php echo $info['market_price']; ?>元
                        </span><br />
                        本店售价：：
                        <span>
                            <font color="red">￥<?php echo $info['shop_price']; ?>元</font>
                        </span>
                    </li>
            ...
            <div style="margin-top:30px;"><a href="flow.php?act=cart&id=<?php echo $info['goods_id']; ?>"><img src="view/images/member_shop.gif" /></a></div>
    ...
    <div class="clear detail_body_footer">
        <div style="border: 1px solid rgb(204, 204, 204); background: transparent url(view/images/ad/ads03.jpg) repeat scroll 0% 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; width: 885px; height: 71px; color: rgb(102, 102, 102);">
    ...
    <div class="detail_info_l">
        ...
        <div class="detail_info_l_body">
            ...
            <div id="ECS_COMMENT">
                ...
                <div class="review">
                    <div class="rev_t">
                        <div class="rev_t_user"><strong>作者：</strong>ecshop</div>
                        <div class="rev_t_time"><strong>时间：</strong>2009-05-12 21:45:20</div>
                        <div class="clear"></div>
                    </div>
                    <div class="rev_m">很好，我很喜欢</div>
			    </div>
